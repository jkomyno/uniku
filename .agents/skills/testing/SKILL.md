---
name: testing
description: Vitest testing guide for uniku. Use when writing or updating library, CLI, integration, Cloudflare e2e, benchmark-result, or Effect-based CLI tests; fixing failing tests; improving coverage; setting up mocks; reviewing test quality; or writing Effect v4 @effect/vitest tests.
---
